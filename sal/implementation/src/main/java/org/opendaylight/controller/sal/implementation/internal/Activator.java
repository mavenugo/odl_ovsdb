...
public class Activator extends ComponentActivatorAbstractBase {
    ...
    public Object[] getGlobalImplementations() {
        Object[] res = { ConnectionService.class, ConfigurationService.class };
        return res;
    }
    ...
    public void configureGlobalInstance(Component c, Object imp) {
        ...
        if (imp.equals(ConfigurationService.class)) {
            c.setInterface(
                    new String[] { INetworkConfigurationService.class.getName() },
                                   null);

            c.add(createServiceDependency()
                    .setService(IPluginInNetworkConfigurationService.class)
                    .setCallbacks("setPluginService", "unsetPluginService")
                    .setRequired(false));
        }
    }
