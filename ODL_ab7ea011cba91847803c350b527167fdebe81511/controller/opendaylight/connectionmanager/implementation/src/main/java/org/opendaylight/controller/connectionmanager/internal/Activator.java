    ...
    protected void configureGlobalInstance(Component c, Object imp) {
        if (imp.equals(ConnectionManager.class)) {
            ...
            c.add(createServiceDependency().setService(IConnectionService.class)
                    ...
                    .setRequired(true));
            c.add(createServiceDependency().setService(INetworkConfigurationService.class)
                    .setCallbacks("setNetworkConfigurationService", "unsetNetworkConfigurationService")
                    .setRequired(true));
        }
    }
}
